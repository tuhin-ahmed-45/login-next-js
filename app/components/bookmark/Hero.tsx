    ...
    <div>
      <section className="relative">
        <div className="container flex flex-col-reverse lg:flex-row items-center gap-12 mt-14 lg:mt-28">
          ...
          <div className="flex justify-center w-5/6 h-5/6 sm:w-3/4 sm:h-3/4 md:w-full md:h-full flex-1 mb-10 md:mb-16 lg:mb-0 z-10 relative">
            <Image fill className="" src={"/images/hero-bg.png"} alt="bg" />
          </div>
        </div>
